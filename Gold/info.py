...
_cookies_path = "/root/cookies/cookies.txt"
cookies_file = _cookies_path if __import__('os').path.exists(_cookies_path) else None
...
async def download(bot_username, link, video: Union[bool, str] = None):
        ...
        if video:
            cmd = ["yt-dlp", "-g", "-f", "best[height<=?720][width<=?1280]",
                   ...
                   "--add-header", "User-Agent:com.google.android.youtube/17.31.35 (Linux; U; Android 11) gzip"]
            if cookies_file:
